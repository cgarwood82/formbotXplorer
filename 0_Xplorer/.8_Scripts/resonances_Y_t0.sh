...
output_filename="$HOME/printer_data/config/03_Resonances_Measurements/shaper_calibrate_y_t0_${time_str}_${date_str}.png"
...
shaper_output=$(~/klippy-env/bin/python3 ~/klipper/scripts/calibrate_shaper.py "$latest_file" -o "$output_filename")
