...
SERIAL_FILE="$HOME/printer_data/config/02__Boards_Serials/Tool3_serial.cfg"
CONFIG_FILE="$HOME/printer_data/config/0_Xplorer/.9_MCU_Flash/MCU_config/BTT_EBB36/.config"
